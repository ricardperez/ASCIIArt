...
std::string *ASCIIArt::newASCIIArtStringForImageName(const std::string &imageName, cv::Mat &resultImage, int nRows, int nColumns)
{
	...
	std::vector<std::vector<RegionOpacity> > *imageOpacities = this->imageFragmenter.newOpacitiesForImage(imageName, resultImage, nRows, nColumns);
...
{	
	std::string *imageStr = new std::string();
	std::vector<std::vector<RegionOpacity> > *imageOpacities = this->imageFragmenter.newOpacitiesForImageMat(imageMat, resultImage, nRows, nColumns);
